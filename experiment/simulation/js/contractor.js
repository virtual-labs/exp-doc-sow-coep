    ...
    <div class="row" id="result-div">
        ...
        <div class="col-2" style="border:2px solid black;" >
			<div class="heading" style="background-color:#425c64; border-radius: 25px; margin-top: 10px;">
			   <p class="heading-text text-center" style="color: white; font-size: 20px; font-weight: 800;">Organisations</p>
		    </div>
...
//            const text = paper.text(x, y, label).attr({ "font-size": 12 });
		...
		const text = paper.text(x+300, y-50, "Identify various departments which are essential to complete the project as per your role - Contractor").attr({ "font-size": 15 });
        ...
        const child1 = drawNode(250, 200);
        const child2 = drawNode(550, 200);
        const child3 = drawNode(750, 200);
//		const child4 = drawNode(400, 200);
        const grandchild1 = drawNode(250, 270);
        const grandchild2 = drawNode(250, 320);
        const grandchild3 = drawNode(150, 420);
        const grandchild4 = drawNode(350, 420);
...
//        connect(root, child4);
	...
	const dropZones = [
		...
		{ x: (x + 90), y: (y + 175), width: 120, height: 30, type: "pro", occupied: false },
		{ x: (x + 90), y: (y + 105), width: 120, height: 30, type: "engg", occupied: false },
...
//		{ x: (x + 390), y: (y + 160), width: 120, height: 40, type: "IT", occupied: false },
		{ x: (x + 220), y: (y + 325), width: 60, height: 30, type: "QA", occupied: false },
		{ x: (x ), y: (y + 325), width: 100, height: 30, type: "soft", occupied: false },
//		{ x: (x + 560), y: (y + 205), width: 90, height: 30, type: "buss", occupied: false },
...
//		{ x: (x + 550), y: (y + 225), width: 120, height: 40, type: "infra", occupied: false },
		{ x: (x + 580), y: (y + 105), width: 120, height: 30, type: "legal", occupied: false },
		{ x: (x + 90), y: (y + 230), width: 120, height: 30, type: "control", occupied: false },
//		{ x: (x + 450), y: (y + 205), width: 100, height: 30, type: "mang", occupied: false },
//		{ x: (x + 230), y: (y + 340), width: 120, height: 40, type: "QA", occupied: false },
//		{ x: (x + 330), y: (y + 205), width: 100, height: 30, type: "tran", occupied: false },
		{ x: (x + 400), y: (y + 105), width: 120, height: 30, type: "fina", occupied: false },
