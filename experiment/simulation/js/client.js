                     ...
                     <div class="col-12 mt-3">
                      ...
                      <div class="col-12 mt-3">
                        <div class="component" draggable="true" data-type="auto">
                            <img src="images/auto.png" alt="auto" draggable="false" style="width: 52%;">
                        </div>
                    </div>
...
//            const text = paper.text(x, y, label).attr({ "font-size": 12 });
		...
		const text = paper.text(x+300, y-50, "Identify various departments which are essential to complete the project as per your role - Client (Project)").attr({ "font-size": 15 });
...
//		const child4 = drawNode(400, 200);
        const grandchild1 = drawNode(300, 270);
...
//        connect(grandchild2, grandchild4);
	...
	const dropZones = [
		...
		{ x: (x + 180), y: (y + 175), width: 50, height: 30, type: "IT", occupied: false },
		...
		{ x: (x + 400), y: (y + 105), width: 120, height: 30, type: "opera", occupied: false },
