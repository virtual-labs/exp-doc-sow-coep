...
//            const text = paper.text(x, y, label).attr({ "font-size": 12 });
		...
		const text = paper.text(x+300, y-50, "Identify various departments which are essential to complete the project as per your role - Consultant").attr({ "font-size": 15 });
        ...
        const grandchild1 = drawNode(700, 300);
        const grandchild2 = drawNode(800, 300);
        const grandchild3 = drawNode(500, 300);
        const grandchild4 = drawNode(600, 300);
        ...
        connect(root, child3);
        connect(root, child4);
        connect(child3, grandchild1);
        connect(child3, grandchild2);
        connect(child2, grandchild3);
...
//		{ x: (x + 550), y: (y + 40), width: 120, height: 40, type: "project", occupied: false },
		{ x: (x + 240), y: (y + 105), width: 120, height: 30, type: "solu", occupied: false },
...
//		{ x: (x + 550), y: (y + 225), width: 120, height: 40, type: "infra", occupied: false },
		{ x: (x + 580), y: (y + 105), width: 120, height: 30, type: "sales", occupied: false },
...
//		{ x: (x + 230), y: (y + 340), width: 120, height: 40, type: "QA", occupied: false },
		...
		{ x: (x + 400), y: (y + 105), width: 120, height: 30, type: "resear", occupied: false },
		{ x: (x + 670), y: (y + 205), width: 80, height: 30, type: "legal", occupied: false },
	];
